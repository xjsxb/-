<template>
  <div>
    <p>
      <span style="color: skyblue; font-size: 28px"
        >中国诗词大会题库管理系统</span
      ><span style="float: right; margin-top: 20px"
        ><el-tag effect="plain"
          >当前用户&nbsp;:&nbsp;<span style="color: red">{{
            currentUserName
          }}</span></el-tag
        >&nbsp;&nbsp;&nbsp;<el-tag effect="plain"
          >当前身份&nbsp;:&nbsp;<span style="color: red">{{
            currentType
          }}</span></el-tag
        ></span
      >
              ...
              >
                ...
                <el-submenu index="4">
                  ...
                  <el-submenu index="4-1">
                    <template slot="title"
                      ><i class="el-icon-myAdd"></i>添加试题</template
                    >
                  ...
                  <el-submenu index="4-2">
                    <template slot="title"
                      ><i class="el-icon-mySearch"></i>查看试题</template
                    >
